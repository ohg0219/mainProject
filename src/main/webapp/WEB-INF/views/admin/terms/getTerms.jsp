                            	...
                            	<input type="hidden" name="state" value="${state}">
							 	<div class="table-responsive">
	                           		<table class="table table-bordered" id="dataTable" >
                    					...
                    					<tr>
                    						<td>날짜</td><td><fmt:formatDate value="${terms.regDate}" pattern="yyyy-MM-dd" /></td>
                    					<tr>
                    						<td align="center" colspan="2"><strong>내용</strong></td>
                    					</tr>
                    					<tr>
                    						<td colspan="2" height="300"><textarea name="content" rows="30px" style="resize: none; width: 100%;" readonly="readonly">${terms.content}</textarea></td>
