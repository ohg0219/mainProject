...
public class AwsS3 {
	...
	final private String accessKey = "AKIAVXP33K37NX6CS2BU"; // IAM 에서 만든 액세스 키
	final private String secretKey = "fRvTKpx1LQDBnxQYWDxx3z12EmDkgjJ4sqKumFAU"; // IAM 에서 받은 시크릿 키 ( 분실시 액세스키 재발급 받아야합니다. )
	private Regions clientRegion = Regions.AP_NORTHEAST_2;
	private String bucket = "thisisthat"; // 버킷 명
